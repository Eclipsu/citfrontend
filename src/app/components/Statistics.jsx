export default function components() {
  return (
    <section class="text-gray-600 body-font w-screen bg-[#DEF6F3]">
      <div class="container px-5 py-24 mx-auto h-20 items-center">
        <div class="flex flex-wrap -m-4 text-center">
          ...
          <div class="p-4 sm:w-1/4 w-1/2">
            ...
            <p class="leading-relaxed">COMMUNITITES</p>
          </div>
        </div>
      </div>
    </section>
